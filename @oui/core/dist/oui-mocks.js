...
module.exports = {
	...
	OIconButton: ({ color, size, svg, handleClick, ...rest }) => {
		baseClasses =
			'px-2 py-2 bg-transparent shadow-none text-main_text hover:text-accent_blue_1 active:text-main_text focus-visible:outline-none focus-visible:shadow-[0px_0px_0px_3px_rgba(27,157,217,1.0)]';
		...
		return (
			<button className={`${baseClasses}`} onClick={handleClick} {...rest}>
