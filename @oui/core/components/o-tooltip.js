...
const OTooltip$1 = /*@__PURE__*/ proxyCustomElement(class OTooltip extends H {
    ...
    static get watchers() { return {
        ...
        "content": ["handleOptionsChange"],
        "hoist": ["handleOptionsChange"],
        "placement": ["handleOptionsChange"],
        "disabled": ["handleDisabledChange"]
    }; }
    static get style() { return oTooltipCss; }
}, [1, "o-tooltip", {
        "content": [1],
        "open": [1028],
        "placement": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["o-tooltip", "o-popup"];
    components.forEach(tagName => { switch (tagName) {
        case "o-tooltip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, OTooltip$1);
            }
            break;
        case "o-popup":
            if (!customElements.get(tagName)) {
...
const OTooltip = OTooltip$1;
const defineCustomElement = defineCustomElement$1;

export { OTooltip, defineCustomElement };
